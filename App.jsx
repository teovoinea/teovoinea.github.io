	...
	render() {
		return (
			<div className="col-md-12">
				...
				<div>
					<ul>
						<li><p><strong><a className="link" href="https://www.github.com/Rumsha7/signkit-learn">signkit-learn</a></strong> - A web app that allows users to practice their sign language skills</p></li>
